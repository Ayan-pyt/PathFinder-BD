...
const userSchema = new mongoose.Schema({
  ...
  journeyStage: {
    type: String,
    enum: ['exploring', 'shortlisting', 'applying', 'visa', 'accepted'],
    default: 'exploring'
  },
  shortlistedCountries: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Country' }],
  targetUniversities:   [{ type: mongoose.Schema.Types.ObjectId, ref: 'University' }],
  bookmarkedScholarships: [{
    universityId: { type: String, default: 'static' },
